...
- **Documentation**: Prefer descriptive test and step names over comments that restate the action. Keep comments focused on intent, browser behaviour, or accessibility rationale.
